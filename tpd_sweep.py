...
def run_once(Te, L, I0, dw):
    ...
    # modify config
    with mlflow.start_run(run_name=f"Te={Te:.2f}, L={L:.2f}, I0={I0:.2e}, dw={float(dw)}") as mlflow_run:
...
if __name__ == "__main__":
    ...
    for Te, L, I0, dw in all_inputs:
        # for I0 in I0s:
        res.append(run_once(Te=Te, L=L, I0=I0, dw=dw))
