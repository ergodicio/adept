...
from adept._vlasovboltzmann1d.helpers import _initialize_total_distribution_, post_process
from adept._vlasovboltzmann1d.solvers.vector_field import VFPBoltzmann
from adept._vlasovboltzmann1d.storage import get_save_quantities


class BaseVlasovFokkerPlanckBoltzmann1D(ADEPTModule):
    ...
    def init_diffeqsolve(self):
        ...
        self.diffeqsolve_quants = dict(
            terms=ODETerm(VFPBoltzmann(self.cfg)),
            solver=Stepper(),
